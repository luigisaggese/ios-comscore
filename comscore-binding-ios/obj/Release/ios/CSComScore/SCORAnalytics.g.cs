...
namespace CSComScore {
	...
	public unsafe partial class SCORAnalytics : NSObject {
		...
		[CompilerGenerated]
		public static void AggregateWithEventInfo (SCOREventInfo eventInfo)
		{
			if (eventInfo == null)
		...
		[CompilerGenerated]
		public static SCORConfiguration Configuration ()
		{
			return  Runtime.GetNSObject<SCORConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("configuration")));
		}
		...
		[CompilerGenerated]
		public unsafe static void GetActivationCategoriesWithKey (string key, string url, SCORPublisherConfiguration publisherConfiguration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSArray> callback)
		{
			if (key == null)
		...
		[CompilerGenerated]
		public static void NotifyHiddenEventWithEventInfo (SCOREventInfo eventInfo)
		{
			if (eventInfo == null)
				throw new ArgumentNullException ("eventInfo");
		...
		[CompilerGenerated]
		public static void NotifyViewEventWithEventInfo (SCOREventInfo eventInfo)
		{
			if (eventInfo == null)
				throw new ArgumentNullException ("eventInfo");
