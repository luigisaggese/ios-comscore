...
namespace CSComScore {
	...
	public unsafe partial class SCORConfiguration : NSObject {
		...
		[CompilerGenerated]
		public virtual void AddClientWithConfiguration (SCORClientConfiguration clientConfiguration)
		{
		...
		[Export ("addDelegate:")]
		[CompilerGenerated]
		public virtual void AddDelegate (SCORConfigurationDelegate @delegate)
		{
			if (@delegate == null)
		...
		[CompilerGenerated]
		public virtual SCORPartnerConfiguration PartnerConfigurationWithPartnerId (string partnerId)
		{
			if (partnerId == null)
				throw new ArgumentNullException ("partnerId");
			var nspartnerId = NSString.CreateNative (partnerId);
			
			SCORPartnerConfiguration ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<SCORPartnerConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("partnerConfigurationWithPartnerId:"), nspartnerId));
			} else {
				ret =  Runtime.GetNSObject<SCORPartnerConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("partnerConfigurationWithPartnerId:"), nspartnerId));
			}
		...
		[CompilerGenerated]
		public virtual SCORPublisherConfiguration PublisherConfigurationWithPublisherId (string publisherId)
		{
			if (publisherId == null)
				throw new ArgumentNullException ("publisherId");
			var nspublisherId = NSString.CreateNative (publisherId);
			
			SCORPublisherConfiguration ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<SCORPublisherConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("publisherConfigurationWithPublisherId:"), nspublisherId));
			} else {
				ret =  Runtime.GetNSObject<SCORPublisherConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("publisherConfigurationWithPublisherId:"), nspublisherId));
			}
		...
		[CompilerGenerated]
		public virtual void RemoveDelegate (SCORConfigurationDelegate @delegate)
		{
			if (@delegate == null)
				throw new ArgumentNullException ("@delegate");
			if (IsDirectBinding) {
