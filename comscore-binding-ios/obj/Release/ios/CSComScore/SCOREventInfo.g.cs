...
namespace CSComScore {
	...
	public unsafe partial class SCOREventInfo : NSObject {
		...
		[CompilerGenerated]
		public virtual SCOREventInfo Copy {
			[Export ("copy")]
			get {
				SCOREventInfo ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SCOREventInfo> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("copy")));
				} else {
					ret =  Runtime.GetNSObject<SCOREventInfo> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("copy")));
				}
				return ret;
			}
