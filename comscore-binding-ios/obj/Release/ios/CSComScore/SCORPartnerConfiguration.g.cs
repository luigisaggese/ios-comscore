...
namespace CSComScore {
	...
	public unsafe partial class SCORPartnerConfiguration : SCORClientConfiguration {
		...
		[CompilerGenerated]
		public SCORPartnerConfiguration (SCORPartnerConfigurationBuilder builder)
		...
		[CompilerGenerated]
		public unsafe static SCORPartnerConfiguration PartnerConfigurationWithBuilderBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<SCORPartnerConfigurationBuilder> block)
		{
			if (block == null)
			...
			ret =  Runtime.GetNSObject<SCORPartnerConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("partnerConfigurationWithBuilderBlock:"), (IntPtr) block_ptr_block));
