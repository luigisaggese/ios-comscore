...
namespace CSComScore {
	...
	public unsafe partial class SCORPartnerConfigurationBuilder : SCORClientConfigurationBuilder {
		...
		[CompilerGenerated]
		public virtual SCORPartnerConfiguration Build {
			[Export ("build")]
			get {
				SCORPartnerConfiguration ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SCORPartnerConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("build")));
				} else {
					ret =  Runtime.GetNSObject<SCORPartnerConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("build")));
				}
				return ret;
			}
