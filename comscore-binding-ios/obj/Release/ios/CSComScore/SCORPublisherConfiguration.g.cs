...
namespace CSComScore {
	...
	public unsafe partial class SCORPublisherConfiguration : SCORClientConfiguration {
		...
		[CompilerGenerated]
		public SCORPublisherConfiguration (SCORPublisherConfigurationBuilder builder)
		...
		[CompilerGenerated]
		public unsafe static SCORPublisherConfiguration PublisherConfigurationWithBuilderBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<SCORPublisherConfigurationBuilder> block)
		{
			if (block == null)
			...
			ret =  Runtime.GetNSObject<SCORPublisherConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("publisherConfigurationWithBuilderBlock:"), (IntPtr) block_ptr_block));
