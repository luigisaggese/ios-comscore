...
namespace CSComScore {
	...
	public unsafe partial class SCORPublisherConfigurationBuilder : SCORClientConfigurationBuilder {
		...
		[CompilerGenerated]
		public virtual SCORPublisherConfiguration Build {
			[Export ("build")]
			get {
				SCORPublisherConfiguration ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SCORPublisherConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("build")));
				} else {
					ret =  Runtime.GetNSObject<SCORPublisherConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("build")));
				}
				return ret;
			}
