...
namespace CSComScore {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "PlaybackSession", Selector = "playbackSession", PropertyType = typeof (CSComScore.SCORStreamingPlaybackSession), GetterSelector = "playbackSession", ArgumentSemantic = ArgumentSemantic.None)]
	...
	internal sealed class SCORStreamingAnalyticsProtocolWrapper : BaseWrapper, ISCORStreamingAnalyticsProtocol {
		...
		[CompilerGenerated]
		public SCORStreamingPlaybackSession PlaybackSession {
			[Export ("playbackSession")]
			get {
				return  Runtime.GetNSObject<SCORStreamingPlaybackSession> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("playbackSession")));
			}
...
namespace CSComScore {
	...
	public unsafe abstract partial class SCORStreamingAnalyticsProtocol : NSObject, ISCORStreamingAnalyticsProtocol {
		...
		[CompilerGenerated]
		public abstract SCORStreamingPlaybackSession PlaybackSession {
			[Export ("playbackSession")]
			get; 
		}
