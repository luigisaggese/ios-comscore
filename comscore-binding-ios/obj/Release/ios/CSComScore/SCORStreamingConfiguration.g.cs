...
namespace CSComScore {
	...
	public unsafe partial class SCORStreamingConfiguration : NSObject {
		...
		[CompilerGenerated]
		public SCORStreamingConfiguration (SCORStreamingConfigurationBuilder builder)
		...
		[CompilerGenerated]
		public unsafe static SCORStreamingConfiguration StreamingConfigurationWithBuilderBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V3))]global::System.Action<SCORStreamingConfigurationBuilder> block)
		{
			if (block == null)
			...
			SCORStreamingConfiguration ret;
			ret =  Runtime.GetNSObject<SCORStreamingConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("streamingConfigurationWithBuilderBlock:"), (IntPtr) block_ptr_block));
