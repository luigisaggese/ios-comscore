...
namespace CSComScore {
	...
	public unsafe partial class SCORStreamingConfigurationBuilder : NSObject {
		...
		[CompilerGenerated]
		public virtual SCORStreamingConfiguration Build {
			[Export ("build")]
			get {
				SCORStreamingConfiguration ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SCORStreamingConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("build")));
				} else {
					ret =  Runtime.GetNSObject<SCORStreamingConfiguration> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("build")));
				}
				return ret;
			}
