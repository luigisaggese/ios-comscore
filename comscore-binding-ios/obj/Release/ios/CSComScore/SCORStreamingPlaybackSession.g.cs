...
namespace CSComScore {
	...
	public unsafe partial class SCORStreamingPlaybackSession : NSObject {
		...
		[CompilerGenerated]
		public virtual SCORStreamingAsset Asset {
			[Export ("asset")]
			get {
				SCORStreamingAsset ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SCORStreamingAsset> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("asset")));
				} else {
					ret =  Runtime.GetNSObject<SCORStreamingAsset> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("asset")));
				}
				return ret;
			}
