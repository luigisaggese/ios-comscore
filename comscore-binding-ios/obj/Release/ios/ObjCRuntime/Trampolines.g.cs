...
namespace ObjCRuntime {
	...
	static partial class Trampolines {
		...
		[UserDelegateType (typeof (global::System.Action<global::CSComScore.SCORPartnerConfigurationBuilder>))]
		...
		static internal class SDActionArity1V1 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr obj) {
				...
				var del = (global::System.Action<global::CSComScore.SCORPartnerConfigurationBuilder>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<CSComScore.SCORPartnerConfigurationBuilder> (obj));
			}
		...
		internal class NIDActionArity1V1 {
			...
			[Preserve (Conditional=true)]
			public unsafe static global::System.Action<global::CSComScore.SCORPartnerConfigurationBuilder> Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				if (BlockLiteral.IsManagedBlock (block)) {
					var existing_delegate = ((BlockLiteral *) block)->Target as global::System.Action<global::CSComScore.SCORPartnerConfigurationBuilder>;
			...
			[Preserve (Conditional=true)]
			unsafe void Invoke (global::CSComScore.SCORPartnerConfigurationBuilder obj)
			{
		...
		[UnmanagedFunctionPointerAttribute (CallingConvention.Cdecl)]
		[UserDelegateType (typeof (global::System.Action<global::CSComScore.SCORPublisherConfigurationBuilder>))]
		...
		static internal class SDActionArity1V2 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr obj) {
				var descriptor = (BlockLiteral *) block;
				var del = (global::System.Action<global::CSComScore.SCORPublisherConfigurationBuilder>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<CSComScore.SCORPublisherConfigurationBuilder> (obj));
			}
		...
		internal class NIDActionArity1V2 {
			...
			[Preserve (Conditional=true)]
			public unsafe static global::System.Action<global::CSComScore.SCORPublisherConfigurationBuilder> Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				if (BlockLiteral.IsManagedBlock (block)) {
					var existing_delegate = ((BlockLiteral *) block)->Target as global::System.Action<global::CSComScore.SCORPublisherConfigurationBuilder>;
					if (existing_delegate != null)
						return existing_delegate;
				}
			...
			[Preserve (Conditional=true)]
			unsafe void Invoke (global::CSComScore.SCORPublisherConfigurationBuilder obj)
			{
				invoker (blockPtr, obj == null ? IntPtr.Zero : obj.Handle);
			}
		...
		[UnmanagedFunctionPointerAttribute (CallingConvention.Cdecl)]
		[UserDelegateType (typeof (global::System.Action<global::CSComScore.SCORStreamingConfigurationBuilder>))]
		...
		static internal class SDActionArity1V3 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr obj) {
				var descriptor = (BlockLiteral *) block;
				var del = (global::System.Action<global::CSComScore.SCORStreamingConfigurationBuilder>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<CSComScore.SCORStreamingConfigurationBuilder> (obj));
			}
		...
		internal class NIDActionArity1V3 {
			...
			[Preserve (Conditional=true)]
			public unsafe static global::System.Action<global::CSComScore.SCORStreamingConfigurationBuilder> Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				if (BlockLiteral.IsManagedBlock (block)) {
					var existing_delegate = ((BlockLiteral *) block)->Target as global::System.Action<global::CSComScore.SCORStreamingConfigurationBuilder>;
					if (existing_delegate != null)
						return existing_delegate;
				}
			...
			[Preserve (Conditional=true)]
			unsafe void Invoke (global::CSComScore.SCORStreamingConfigurationBuilder obj)
			{
				invoker (blockPtr, obj == null ? IntPtr.Zero : obj.Handle);
			}
